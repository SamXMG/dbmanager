...
<style scoped>
.props-panel { width: 240px; flex-shrink: 0; border-left: 1px solid var(--border, #e4e7ed); display: flex; flex-direction: column; min-height: 0; }
.p-head { padding: 6px 10px; font-weight: 600; font-size: 13px; border-bottom: 1px solid var(--border, #e4e7ed); }
...
.p-item label { color: var(--text2, #86909c); }
.p-item span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.p-sec { margin: 10px 0 4px; font-size: 12px; color: var(--text2, #86909c); font-weight: 600; }
...
.p-tbl th { color: var(--text3, #86909c); font-weight: 500; }
.empty2 { color: var(--text3, #999); font-size: 12px; }
</style>
