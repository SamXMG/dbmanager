...
<style scoped>
.doc-tabs { display: flex; align-items: center; gap: 2px; padding: 0 8px; border-bottom: 1px solid var(--border, #e4e7ed); overflow-x: auto; flex-shrink: 0; }
...
.doctab.active { background: var(--panel, #fff); border-color: var(--border, #e4e7ed); border-bottom-color: transparent; font-weight: 600; }
.x { color: #999; font-size: 14px; line-height: 1; padding: 0 2px; }
